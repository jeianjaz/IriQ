...
export default function Login() {
  ...
  useEffect(() => {
    // Check for query parameters that indicate a redirect with a message
    ...
    if (verified === 'true') {
      showNotification('success', 'Email verified successfully! You can now log in.')
    }
    
    if (reset === 'success') {
      showNotification('success', 'Password reset successfully! You can now log in with your new password.')
    }
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 text-[#7AD63D] focus:ring-[#7AD63D] border-gray-300 rounded"
                  />
                ...
                <div className="text-sm">
                  <Link href="/forgot-password" className="font-medium text-[#7AD63D] hover:text-[#69c52c]">
                    Forgot password?
                  </Link>
                </div>
              </div>
              ...
              <div className="text-center mt-4">
                <p className="text-sm text-gray-600">
                  ...
                  <Link href="/signup" className="font-medium text-[#7AD63D] hover:text-[#69c52c]">
                    Sign up
                  </Link>
                </p>
              </div>
